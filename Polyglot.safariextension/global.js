...
function handleGetSettings(msg) {
  const targetTab = msg.target
  if (targetTab.reader.available) {
    targetTab.reader.dispatchMessage('settingsReceived', settings)
  }
  targetTab.page.dispatchMessage('settingsReceived', settings)
}
